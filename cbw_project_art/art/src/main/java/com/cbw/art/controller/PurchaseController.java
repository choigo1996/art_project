...
public class PurchaseController {
	...
	public ResponseEntity<BaseResponse<Void>> savePurchase(@RequestBody @Valid PurchseDto purchseDto,Authentication authentication){
		return new ResponseEntity<>(
				purchaseServiceImpl.savePurchase(authentication, purchseDto),
				HttpStatus.CREATED);
	}
	//모든 회원의 구매정보 불러오기
	@GetMapping("/list")
